...
if ( ! empty( $tabs ) ) : ?>
	...
	<div class="woocommerce-tabs wc-tabs-wrapper clearfix tabs-layout-<?php echo esc_attr( $tabs_layout ); ?> <?php echo (esc_attr($review_count) == 0) ? 'wc-no-reviews' : ''; ?>">
		...
		<?php if( $tabs_layout == 'accordion' ) : ?>
			<?php foreach ( $tabs as $key => $tab ) : ?>
				<div class="koganic-tab-wrapper">
					<a href="#tab-<?php echo esc_attr( $key ); ?>" data-toggle="collapse" class="koganic-accordion-title"><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', esc_html( $tab['title'] ), $key ); ?></a>
