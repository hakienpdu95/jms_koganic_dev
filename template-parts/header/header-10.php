...
<div class="container">
    <div class="wrap-header color-black">
        ...
        <!-- menu-toggle -->
        <div class="header-position header-left header-logo hidden-lg">
            <div class="header-block">
                <?php koganic_logo(); ?>
            </div>
        </div>        
        <div class="header-position header-left header-navigation hidden-md hidden-xs hidden-sm">
            <div class="header-block">
        ...
        <div class="header-position header-right text-right header-action">
            <div class="header-block search-block desctop hidden-md hidden-xs hidden-sm">
